...
namespace Appointment.Controllers
{
    ...
    int? scheduleId = null)
        ...
        // Merged from AppointmentMainApiController
            ...
            try
            {
                ...
                var uniquePatients = appointmentsResponse.Result.Result
                    ...
                    .Select(a => new PatientListByDoctorDto
                    {
                        ...
                        PatientCode = "N/A", // PatientCode not available in AppointmentApiResponseDto
                        PatientMobileNo = a.PhoneNumber ?? "N/A", // Using PhoneNumber from AppointmentApiResponseDto
                        PatientEmail = "N/A" // PatientEmail not available in AppointmentApiResponseDto
                    })
                    .ToList();
