...
using DoctorExpertise.Utility;

namespace DoctorExpertise.Insfracture.RepositoriesImplement.DoctorExpertise
{
    public class DoctorExpertiseCommandRepository : IDoctorExpertiseCommandRepository
    {
        ...
        // Delete a Doctor Expertise by ID
        ...
        // Update an existing Doctor Expertise
