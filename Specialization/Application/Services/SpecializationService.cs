...
namespace Specialization.Application.Services
{
    public class SpecializationService
    {
        ...
        public async Task<Response<List<Entities.EntityClass.Specialization>>> GetBySpecialityId(int specialityId)
        {
            ...
            try
            {
                var specialization = await _specializationQueryRepository.GetBySpecialityId(specialityId);
        ...
        public async Task<Response<List<Entities.EntityClass.Specialization>>> GetFiltered()
        {
            ...
            try
            {
                var specialization = await _specializationQueryRepository.GetFiltered();
