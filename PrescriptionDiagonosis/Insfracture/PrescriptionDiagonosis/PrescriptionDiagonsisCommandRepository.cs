    ...
    public class PrescriptionDiagonsisCommandRepository : IPrescriptionDiagonsisCommandRepository
    {
        ...
        public async Task<Response<bool>> Delete(int id)
        {
            ...
            try
            {
                ...
                ResponseHelper.SetSuccessResponse(response, true, PrescriptionDiagonsisResponseMessage.common_delete_success_message, StatusResponseMessage.success, StatusCodes.Status200OK);
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response<int>> Insert(Entities.EntityClass.PrescriptionEntity.PrescriptionDiagnosis entity)
        {
            ...
            try
            {
                ...
                if (result == 0)
                {
                    ...
                    ResponseHelper.SetFailedResponse(response, 0, PrescriptionDiagonsisResponseMessage.common_inserted_failed_message, StatusResponseMessage.failed, StatusCodes.Status400BadRequest);
                }
                else
                {
                    response.Result = result;
                    response.IsSuccess = true;
                    ResponseHelper.SetSuccessResponse(response, result, PrescriptionDiagonsisResponseMessage.common_insert_success_message, StatusResponseMessage.success, StatusCodes.Status201Created);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response<int>> Update(Entities.EntityClass.PrescriptionEntity.PrescriptionDiagnosis entity)
        {
            ...
            try
            {
                ...
                if (result == 0)
                {
                    ...
                    ResponseHelper.SetFailedResponse(response, result, PrescriptionDiagonsisResponseMessage.common_update_failed_message, StatusResponseMessage.failed, StatusCodes.Status400BadRequest);
                }
                else
                {
                    response.Result = result;
                    response.IsSuccess = true;
                    ResponseHelper.SetSuccessResponse(response, result, PrescriptionDiagonsisResponseMessage.common_update_success_message, StatusResponseMessage.success, StatusCodes.Status200OK);
