namespace AuthenticationSystem.Utility
{
    public static class AuthResponseMessage
    {
        public const string common_get_all_success = "SUCCESS: Data retrieved successfully.";
        public const string common_get_by_id_success = "SUCCESS: Data retrieved successfully.";
