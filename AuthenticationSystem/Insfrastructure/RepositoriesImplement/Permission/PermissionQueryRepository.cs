...
namespace AuthenticationSystem.Insfrastructure.RepositoriesImplement.Permission
{
    public class PermissionQueryRepository : IPermissionQueryRepository
    {
        ...
        public PermissionQueryRepository(ISqlDataAccessLayer dataAccess)
        {
        ...
        public async Task<Response<List<Entities.EntityClass.Permission>>> GetAll()
        {
            var response = new Response<List<Entities.EntityClass.Permission>>();
            try
            {
                var result = await _dataAccess.LoadDataUsingProcedure<Entities.EntityClass.Permission, dynamic>("Permission_GetAll", new { });
        ...
        public async Task<Response<Entities.EntityClass.Permission>> GetById(int id)
        {
            var response = new Response<Entities.EntityClass.Permission>();
            try
            {
                var result = await _dataAccess.LoadSingleDataUsingProcedure<Entities.EntityClass.Permission, dynamic>("Permission_GetById", new
                {
                    Id = id
                });
