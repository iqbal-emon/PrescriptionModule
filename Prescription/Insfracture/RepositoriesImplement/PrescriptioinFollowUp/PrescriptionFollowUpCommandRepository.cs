...
namespace Prescription.Insfracture.RepositoriesImplement.PrescriptioinFollowUp
{
    public class PrescriptionFollowUpCommandRepository : IPrescriptionFollowUpCommandRepository
    {
        private readonly ISqlDataAccessLayer _dataAccess;
        public PrescriptionFollowUpCommandRepository(ISqlDataAccessLayer dataAccess)
        {
        ...
        public async Task<Response<int>> Insert(Entities.EntityClass.PrescriptionEntity.PrescriptionFollowUp entity)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ResponseHelper.SetSuccessResponse(response, result, PrescriptionFollowUpResponseMessage.common_insert_success_message, StatusResponseMessage.success, StatusCodes.Status201Created);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response<int>> Update(Entities.EntityClass.PrescriptionEntity.PrescriptionFollowUp entity)
        {
            var response = new Response<int>();
            try
            {
                ...
                else
                {
                    response.Result = result;
                    response.IsSuccess = true;
                    ResponseHelper.SetSuccessResponse(response, result, PrescriptionFollowUpResponseMessage.common_update_success_message, StatusResponseMessage.success, StatusCodes.Status200OK);
                }
            }
            catch (Exception ex)
            {
